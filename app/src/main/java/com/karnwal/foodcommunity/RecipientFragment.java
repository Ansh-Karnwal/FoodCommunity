...
public class RecipientFragment extends Fragment implements RecipientDialogFragment.OnInputSelected {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.recipientRecycler.setHasFixedSize(true);
        binding.recipientRecycler.setLayoutManager(new LinearLayoutManager(this.getActivity(), LinearLayoutManager.VERTICAL, false));
        adapter = new DonorAdapter(this.getContext(), recipientArrayList, this::editOnClick);
        binding.recipientRecycler.setAdapter(adapter);
        executor.execute(() -> {
            for(;;) {
                ...
                if(reference != null && recipientArrayList.size() == 0) {
                    loadData();
                    break;
                }
            }
        ...
        binding.addButton.setOnClickListener(v -> {
            ...
            dialog.setTargetFragment(RecipientFragment.this, 1);
